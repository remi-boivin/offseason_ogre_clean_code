...
describe("Check method \'baseController\' ", () => {
    ...
    beforeAll(() => {
        dependencies.DeleteBaseCase.prototype.Execute = jest.fn().mockResolvedValue('The entity was deleted');
    });
    ...
    test.skip('should 200 and return correct value', async () => {
        ...
        new dependencies.DeleteBaseCase()
        ...
        expect(res.json).toHaveBeenCalledWith('The entity was deleted');
    });

    test.skip('should 404 and return correct value', async () => {
        let base
        dependencies.DeleteBaseCase.prototype.Execute = jest.fn().mockResolvedValue(base);
    ...
    test('should return The entity was not found Error', async () => {
        ...
        dependencies.DeleteBaseCase.prototype.Execute = jest.fn().mockRejectedValue(new Error('The entity was not found'));
