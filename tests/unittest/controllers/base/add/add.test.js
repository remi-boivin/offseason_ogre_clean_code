...
describe("Check method \'baseController\' ", () => {
    ...
    beforeAll(() => {
        dependencies.AddBaseCase.prototype.Execute = jest.fn().mockResolvedValue(dependencies.datas.valid);
    });
    ...
    test.skip('should 200 and return correct value', async () => {
        ...
        baseController = new controller(dependencies.Base, dependencies.BaseRepository, dependencies.AddBaseCase,
            dependencies.GetBaseCase, dependencies.UpdateBaseCase, dependencies.DeleteBaseCase);
        await baseController.add(req, res, next)
        // expect(res.status).toHaveBeenCalledWith(200)
        expect(next).toHaveBeenCalledWith(dependencies.datas.valid);
    });

    test.skip('should 404 and return correct value', async () => {
        let base
        dependencies.AddBaseCase.prototype.Execute = jest.fn().mockResolvedValue(base);
        ...
        await baseController.add(req, res)
    ...
    test('should return The entity was not found Error', async () => {
        ...
        dependencies.AddBaseCase.prototype.Execute = jest.fn().mockRejectedValue(new Error('The entity was not found'));
